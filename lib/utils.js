...
exports.isPr = isPr;
function getLatestTag(tags, prefixRegex, tagPrefix, suffixRegex, tagSuffix) {
    return (tags.find((tag) => !(0, semver_1.prerelease)(tag.name.replace(prefixRegex, '').replace(suffixRegex, ''))) || {
